...
public class OnlineExamSystemTask4 {
    ...
    public OnlineExamSystemTask4(String username, String password) {
    ...
    public static void main(String[] args) {
        ...
        OnlineExamSystemTask4 examSystem = new OnlineExamSystemTask4(uName, pWord);
        examSystem.login();
